...
docker run -d --name mosquitto6 -p 1886:1883 -v ./mosquitto.conf:/mosquitto/config/mosquitto.conf eclipse-mosquitto:1.6
docker run -d --name mosquitto7 -p 1887:1883 -v ./mosquitto.conf:/mosquitto/config/mosquitto.conf eclipse-mosquitto:1.6
docker run -d --name mosquitto8 -p 1888:1883 -v ./mosquitto.conf:/mosquitto/config/mosquitto.conf eclipse-mosquitto:1.6
docker run -d --name mosquitto9 -p 1889:1883 -v ./mosquitto.conf:/mosquitto/config/mosquitto.conf eclipse-mosquitto:1.6
